...
/*
   ...
   System.out.println(myAccountBalance + ") Kr");


   for (int i = 0; i < myAccountBalance.size(); i++) {
        System.out.println("Initial balance " + myAccountBalance + "Kr" + "Invoice amount" + input1 + "Kr" + "Balance after invoice" + typeInput + "Kr" );
        }
...
//        Scanner print = new Scanner(System.in);
             ...
             System.out.println("Please type in the amount of employees that you wanna pay(integers only).");


System.out.println(Arrays.toString(storage) + "Kr");

 System.out.println(storage[i] * 0.70 + "kr ");
int paycheck = input.nextInt();

for (int i = 0; i < paycheck;)



                for (double i = 0.00; i < employee; i++) {
                    System.out.println("Now type in the paycheck amount below for employee (" + (i + 1) + "): ");
                    System.out.println(input.nextInt() * 0.70 + "kr ");
